...
FEATURE_STATS = {
    'rsi': {'mean': 66.8327, 'std': 46.9062},
    'macd': {'mean': -1.5344, 'std': 3.3293},
    'macd_hist': {'mean': -0.4971, 'std': 1.0928},
    'volatility': {'mean': 0.0, 'std': 0.0},
    'bb_position': {'mean': 0.0673, 'std': 0.0954},
    'ma_distance': {'mean': -0.0114, 'std': 0.0161},
    'price_change_5': {'mean': -0.0021, 'std': 0.003},
    'price_change_10': {'mean': -0.005, 'std': 0.0085},
    'price_change_24': {'mean': -0.0173, 'std': 0.0247},
    'rsi_momentum': {'mean': -1.5333, 'std': 2.9155},
    'volume_ratio': {'mean': 0.6667, 'std': 0.4714},
    'volume_trend': {'mean': 0.0, 'std': 1.0},
    'rsi_4h': {'mean': 66.8327, 'std': 46.9062},
    'dist_from_high': {'mean': 0.022, 'std': 0.0315},
    'dist_from_low': {'mean': 0.0, 'std': 0.0},
    'range_position': {'mean': 0.0, 'std': 0.0001},
    'candle_range': {'mean': 0.0007, 'std': 0.0015},
    'candle_close_pos': {'mean': 0.5, 'std': 1.0},
    'upper_wick': {'mean': 0.0, 'std': 1.0},
    'lower_wick': {'mean': 0.0, 'std': 1.0},
    'adx_proxy': {'mean': 0.2341, 'std': 0.3381},
    'z_score': {'mean': -0.3976, 'std': 0.5631},
    'momentum_5': {'mean': -0.0, 'std': 0.0},
    'momentum_10': {'mean': -0.0, 'std': 0.0001},
    'atr_pct': {'mean': 0.0012, 'std': 0.0017},
    'vpin_norm': {'mean': 0.0, 'std': 1.0},
    'vpin_signal': {'mean': 0.6667, 'std': 0.4714},
},
